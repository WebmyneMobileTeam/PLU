 ...
 *
 * <p>
 * This class is intended to be used from a {@link android.view.LayoutInflater.Factory#onCreateView} method,
 * or from {@link android.view.LayoutInflater.Factory2#onCreateView}. From one of this methods
 * just call to {@link #createView} and it will take care to delegate the view creation to the
 * system {@link android.view.LayoutInflater}, and after the creation try to apply a custom {@code Typeface}
 * if the new created view is an instance of {@link android.widget.TextView}, or any other derived class.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The next step is override the {@link android.app.Activity#onCreateView} method and delegate the view
...
public class CustomTypeface {
     ...
     * {@link android.widget.TextView} defined in the SDK. You can use this method if you create an
    ...
    /**
     * Returns the {@link android.graphics.Typeface} that was registered with the specified name.
     *
     * @param typefaceName a {@code String} with the name of the registered {@code TypeFace}
     * @return a {@link android.graphics.Typeface} or null if not found
     */
    ...
    /**
     * Register a {@link android.graphics.Typeface} with the specified name. This name will be able to be referenced
     ...
     * @param typeface     a {@link android.graphics.Typeface} instance to register
     */
     ...
     * For more information see the {@link #registerTypeface(String, android.graphics.Typeface)} method.
     *
     * @param typefaceName a name that will identify this {@code Typeface}
     * @param assets       a instance of {@link android.content.res.AssetManager}
     * @param filePath     a path to a TTF file located inside the assets folder
     *
     * @see #registerTypeface(String, android.graphics.Typeface)
     */
    ...
    /**
     * Inflate the {@link android.view.View} for the specified tag name and apply custom {@link android.graphics.Typeface} if
     * is required. This method first will delegate the {@code View} creation to
     * {@link android.view.LayoutInflater} and then call {@link #applyTypeface(android.view.View, android.util.AttributeSet)} on
     * the created view.
     *
     * <p>
     * This method can be used to delegate the implementation of {@link android.view.LayoutInflater.Factory#onCreateView}
     * or {@link android.view.LayoutInflater.Factory2#onCreateView}. The most common usage of this method is to call it
     * from {@link android.app.Activity#onCreateView(String, android.content.Context, android.util.AttributeSet)}.
     * </p>
     *
     ...
     * @see #applyTypeface(android.view.View, android.util.AttributeSet)
     */
